...
resource_group_name = "resource-group-iaas"
storage_account_name = "metricstorageiaas"
...
def create_load_balancing_id(input: str):
    return pulumi.Output.concat(
        "/subscriptions/f0225753-f6de-42b8-b862-8c4003ccf2be/resourceGroups/",
        resource_group.name,
...
owner_role_definition_id = "/subscriptions/f0225753-f6de-42b8-b862-8c4003ccf2be/providers/Microsoft.Authorization/roleDefinitions/8e3af657-a8ff-443c-a75c-2fe8c4bcb635"

# Create a Role Assignment for Team Member 1
role_assignment_1 = auth.RoleAssignment(
    "owner-role-assignment",
    principal_id=team_member_1.object_id,
    role_assignment_name="5d60b860-ae36-41c8-9b45-ae854864be30",
...
role_assignment_2 = auth.RoleAssignment(
    ...
    role_assignment_name="8fa84aa9-9f19-421b-b469-21bb684ec80b",
    principal_type=auth.PrincipalType.USER,
    role_definition_id=owner_role_definition_id,
    scope=resource_group.id,
)
